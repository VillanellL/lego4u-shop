...
public class RegisterController {
    ...
    @PostMapping
    public Result<UserResponse> register(@RequestBody UserLogin userLogin, HttpServletRequest request) throws Exception {
        /**
        ...
        //进行登录，并将这个token返回给前台
        UserResponse userResponse = userService.register(userLogin.getPhone(),userLogin.getPassword(),ip);
